...
public class AuthController {
    ...
    private String getAuthenticatedUserRedirectUrl(Authentication authentication) {
        log.warn("WARNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN1");
        log.info("authenticatio: {}", authentication);
        if (authentication != null && authentication.isAuthenticated()) {
            log.warn("WARNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN2");
            String redirectUrl = RedirectUtil.getRedirectUrl(authentication);
            if (redirectUrl != null) {
                return "redirect:" + redirectUrl;
            }
        }
        log.warn("WARNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN3");
        return null;
    }
}
